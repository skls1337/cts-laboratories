...
public class AccidentareUsoara extends HandlerAccidentare {

	@Override
	public void tratareAccidentare(Cursant cursant, Medic medic) {
		if (this.next != null) {
			if (cursant.getStareAccidentare().equals(StareAccidentare.ACCIDENTAT)
			...
			if (medic != null) {
				System.out.println("Se apeleaza medicul asistent");
				medic.callMedic();
			} else {
